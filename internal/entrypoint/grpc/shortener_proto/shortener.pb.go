...
type ShortenerCreateURLData struct {
	...
	URL string `protobuf:"bytes,1,opt,name=URL,proto3" json:"URL,omitempty"`
	TTL *TTL   `protobuf:"bytes,2,opt,name=TTL,proto3" json:"TTL,omitempty"`
}
...
func (x *ShortenerCreateURLData) GetTTL() *TTL {
	if x != nil {
		return x.TTL
	}
	return nil
...
type TTL struct {
	...
	// Unit of time
	Unit string `protobuf:"bytes,1,opt,name=Unit,proto3" json:"Unit,omitempty"` // limitations: min, hour
	// Value of provided time unit
	Value int32 `protobuf:"varint,2,opt,name=Value,proto3" json:"Value,omitempty"` // limitations: min(1<=Value<=525600); hour(1<=Value<=8760)
}

func (x *TTL) Reset() {
	*x = TTL{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shortener_proto_shortener_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TTL) Descriptor() ([]byte, []int) {
	return file_shortener_proto_shortener_proto_rawDescGZIP(), []int{2}
}

func (x *TTL) GetUnit() string {
	if x != nil {
		return x.Unit
	}
	return ""
...
var file_shortener_proto_shortener_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x55, 0x52, 0x4c, 0x22, 0x52, 0x0a, 0x16, 0x53, 0x68, 0x6f, 0x72,
	...
	,
...
var file_shortener_proto_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_shortener_proto_shortener_proto_goTypes = []interface{}{
	...
	(*TTL)(nil),                    // 2: shortener_proto.TTL
}
var file_shortener_proto_shortener_proto_depIdxs = []int32{
	2, // 0: shortener_proto.ShortenerCreateURLData.TTL:type_name -> shortener_proto.TTL
	1, // 1: shortener_proto.Shortener.Create:input_type -> shortener_proto.ShortenerCreateURLData
	0, // 2: shortener_proto.Shortener.Get:input_type -> shortener_proto.ShortenerURLData
	0, // 3: shortener_proto.Shortener.Create:output_type -> shortener_proto.ShortenerURLData
	0, // 4: shortener_proto.Shortener.Get:output_type -> shortener_proto.ShortenerURLData
...
func file_shortener_proto_shortener_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_shortener_proto_shortener_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TTL); i {
			case 0:
				return &v.state
			case 1:
